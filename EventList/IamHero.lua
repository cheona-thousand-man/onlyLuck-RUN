local function displayBuffImage(humanoid, imageID, text)
	...
	imageLabel.Position = UDim2.new(0, 0, 0.15, 0) -- Adjust position as needed
...
return function(humanoid)
	...
	local buffGui = displayBuffImage(humanoid, "rbxassetid://17583471696", "I am Hero")

	-- 사운드 재생 및 sound 객체 반환
	local sound = playSound(humanoid, "rbxassetid://9043709734")
