local function displayBuffImage(humanoid, imageID, text)
	...
	imageLabel.Position = UDim2.new(0, 0, 0.2, 0) -- Adjust position as needed
...
return function(humanoid)
	...
	local buffGui = displayBuffImage(humanoid, "rbxassetid://17583471316", "I can Fly")

	-- 사운드 재생 및 sound 객체 반환
	local sound = playSound(humanoid, "rbxassetid://1846631247")

	-- 여기서 버프 효과 적용
	humanoid.JumpPower = humanoid.JumpPower * 3.5
