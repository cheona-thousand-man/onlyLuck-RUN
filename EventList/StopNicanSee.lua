local function displayBuffImage(humanoid, imageID, text)
	...
	imageLabel.Position = UDim2.new(0, 0, 0.22, 0) -- Adjust position as needed
...
return function(humanoid)
	...
	local buffGui = displayBuffImage(humanoid, "rbxassetid://17583471461", "Break Time")

	-- 사운드 재생 및 sound 객체 반환
	local sound = playSound(humanoid, "rbxassetid://9113690541")
